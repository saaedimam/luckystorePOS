...
- **Source of truth:** `supabase/functions/import-inventory/index.ts` (deployed function)
- **Archived snapshot:** [docs/_archive/2026-03-25/edge-function-snapshot/05-COMPLETE-EDGE-FUNCTION.ts](./_archive/2026-03-25/edge-function-snapshot/05-COMPLETE-EDGE-FUNCTION.ts) (historical copy; prefer the file under `supabase/functions/`)
...
**Data files (repo root `data/`):**

- **[competitors/shwapno/](../data/competitors/shwapno/)** - Shwapno competitor pricing CSV exports
- **[inventory/](../data/inventory/)** - Sample / batch inventory spreadsheets (local reference)

---

## 🗄️ Archived reference (not built)

**Next.js / App Router snippets** (payment return pages, cart) kept for historical reference only. Production checkout uses Supabase Edge Functions and the Vite app under `apps/frontend/`.

- **[docs/_archive/2026-03-25/nextjs-reference/](./_archive/2026-03-25/nextjs-reference/)**
...
- **[01-EXECUTION-PLAN.md](./architecture/01-EXECUTION-PLAN.md)** - Complete project execution plan (10 phases, week-by-week breakdown)
- **[chatgptplan.md](./architecture/chatgptplan.md)** - Original architecture plan
...
### Week 1: Foundation
1. Read [01-EXECUTION-PLAN.md](./architecture/01-EXECUTION-PLAN.md) (overview)
