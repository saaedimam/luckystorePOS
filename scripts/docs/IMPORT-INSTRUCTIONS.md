...
Edit `scripts/import-competitor-data.js` and replace the `SUPABASE_SERVICE_KEY` constant with your full service role key.

## What the Script Does

1. **Reads all CSV files** from `Docs/Competitors Price/`
