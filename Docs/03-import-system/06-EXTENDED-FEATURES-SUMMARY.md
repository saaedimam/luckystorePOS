...
- [ ] Run SQL schema from `supabaseplan.md`
- [ ] Run store seeding SQL from `STORE-SEEDING-SQL.md`
...
See `EXTENDED-IMPORT-TESTING.md` for complete test suite.

---

## Documentation Index

1. **EXTENDED-IMPORT-PLAN.md** - Implementation plan
2. **STORE-SEEDING-SQL.md** - Store setup SQL
3. **EXCEL-TEMPLATE-FULL.md** - Complete template
4. **AUTO-BARCODE-GENERATOR.md** - Barcode generation
5. **AUTO-IMAGE-UPLOAD.md** - Image upload guide
6. **EXTENDED-IMPORT-TESTING.md** - Testing guide
7. **STORE-SETUP-GUIDE.md** - Store management
