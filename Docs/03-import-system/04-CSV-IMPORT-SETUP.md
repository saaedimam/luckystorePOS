...
**Deployment Script:** Use `deploy-edge-function.sh` or follow [IMPORT-DEPLOYMENT-GUIDE.md](./IMPORT-DEPLOYMENT-GUIDE.md)
...
**Location:** `frontend/src/components/BulkImport.tsx`
...
**Location:** `frontend/src/pages/Items.tsx` - `handleBulkImport` function
