...
Follow the file-by-file guide in `REACT-POS-FILE-STRUCTURE.md`
...
1. `REACT-POS-FILE-STRUCTURE.md` - Create all files
2. `REACT-POS-EXECUTION-PLAN.md` - Follow implementation phases
