...
- [x] Run SQL schema from `supabaseplan.md` in Supabase SQL Editor
...
- [x] Create `frontend/src/services/supabase.ts` with client initialization
...
2. Run SQL schema from `supabaseplan.md`
...
3. Open SQL Editor
4. Copy SQL from `Docs/supabaseplan.md`
