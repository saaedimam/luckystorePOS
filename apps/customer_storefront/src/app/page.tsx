    ...
    <main className="flex-1 flex flex-col relative bg-background-default min-h-screen">
      ...
      <header className="sticky top-0 z-50 bg-surface-default/80 backdrop-blur-lg border-b border-border-default px-6 py-4 flex items-center justify-between shadow-level-1">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-primary-default rounded-xl flex items-center justify-center shadow-level-2">
      ...
      <div className="store-container !pt-8">
        <section className="mb-12">
          <div className="bg-primary-default/10 border border-primary-default/20 rounded-3xl p-6 mb-10 flex items-center gap-6 relative overflow-hidden group">
        ...
        {itemCount > 0 && (
          ...
          >
            <button 
              ...
              className="w-full bg-primary-default text-primary-on rounded-full p-2 pl-6 flex items-center justify-between shadow-level-3 hover:bg-primary-hover active:scale-[0.98] transition-all group"
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-lg font-black tracking-tighter tabular-nums">৳{total()}</p>
                </div>
              </div>
              <div className="bg-white/20 rounded-full px-6 py-3 flex items-center gap-2 group-hover:bg-white/30 transition-colors">
                <span className="text-sm font-black uppercase tracking-widest">অর্ডার করুন</span>
