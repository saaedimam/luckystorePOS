...
-- NOTE: record_purchase_v2() and post_draft_purchase_receipt() are now defined in
-- migration 20260427010001_record_purchase_v2_rpc.sql (canonical versions).
-- Table definitions above are kept; RPC function bodies removed to avoid duplicates.
